...
export class OrchestratorServer {
  ...
  constructor() {
    ...
    this.waveEngine = new WaveOrchestratorEngine(
    ...
    this.loopController = new LoopModeController(
      this.performanceTracker,
      this.contextPreserver
    );

    this.chainManager = new ChainModeManager(
      this.performanceTracker,
      this.contextPreserver
    );
  ...
  private async handleCreateWavePlan(args: any) {
  ...
  private async handleExecuteWave(args: any) {
    const { waveId } = args;
  ...
  private async handleDelegateToSubAgents(args: any) {
  ...
  private async handleStartLoop(args: any) {
  ...
  private async handleExecuteLoopIteration(args: any) {
  ...
  private async handleStartChain(args: any) {
    const { configuration, context } = args;
  ...
  private async handleExecuteChain(args: any) {
    const { chainId } = args;
