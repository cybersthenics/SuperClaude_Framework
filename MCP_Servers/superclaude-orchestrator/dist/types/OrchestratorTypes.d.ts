...
export interface OrchestratorServerConfig {
    ...
    delegation: {
        ...
        resultAggregationTimeout: number;
    };
    loopMode: {
...
export type PersonaSpecialization = 'analyzer' | 'architect' | 'frontend' | 'backend' | 'security' | 'performance' | 'qa' | 'devops' | 'mentor' | 'refactorer' | 'scribe';
