...
// SuperClaude Tasks Server - Memory-Enhanced MCP Server Implementation
// Full task management with project memory and context preservation
...
import { ContextPreserver, ContextData } from './memory/ContextPreserver.js';
import { 
...
export class SuperClaudeTasksServerMemory {
  ...
  private async handleUpdateTask(args: any): Promise<any> {
    ...
    // Add task update to project memory
  ...
  private async handleDeleteTask(args: any): Promise<any> {
    ...
    // Add task deletion to project memory
    if (task?.metadata?.projectId) {
      await this.memoryManager.addTaskRecord(task.metadata.projectId, {
        taskId: task.id,
        action: 'deleted',
  ...
  private async handleSaveProjectMemory(args: any): Promise<any> {
    const { projectId } = args;
  ...
  private async handleAddSymbolInfo(args: any): Promise<any> {
  ...
  // Context Preservation Tool Handlers
  ...
  private async handleListContextSnapshots(args: any): Promise<any> {
    const { projectId } = args;
  ...
  private async handleGetSnapshotStatistics(args: any): Promise<any> {
    const { projectId } = args;
  ...
  private async handleGetProjectState(): Promise<any> {
    const projectState = {
  ...
  private async handleGetSymbolIndex(): Promise<any> {
    const symbolIndex = {
  ...
  private async handleGetPerformanceBaseline(): Promise<any> {
