...
export class SuperClaudeTasksServerProduction {
    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                ...
                const result = await this.performanceOptimizer.cacheOperation(`tool:${name}:${JSON.stringify(args)}`, async () => {
                    switch (name) {
                        // Task Management Tools
                        case 'create_task':
                ...
                const recovered = await this.errorRecoverySystem.handleError(error, {
                    operation: name,
                    component: 'server',
                    timestamp: new Date(),
    ...
    async handleCreateTask(args, correlationId) {
    ...
    async handleGetTask(args, correlationId) {
        const { taskId } = args;
    ...
    async handleSearchTasks(args, correlationId) {
    ...
    async handleGetTaskStats(args, correlationId) {
    ...
    async handleCreateProjectMemory(args, correlationId) {
    ...
    async handleCreateContextSnapshot(args, correlationId) {
    ...
    async handleRegisterAgent(args, correlationId) {
    ...
    async handleDistributeToSubAgents(args, correlationId) {
    ...
    async handleCoordinateWorkflow(args, correlationId) {
    ...
    async handleMakeCrossServerRequest(args, correlationId) {
    ...
    async handleGetServerHealth(args, correlationId) {
    ...
    async handleGetPerformanceMetrics(args, correlationId) {
    ...
    async handleGetErrorStatistics(args, correlationId) {
    ...
    async handleAcknowledgeAlert(args, correlationId) {
    ...
    async handleGenerateSystemReport(args, correlationId) {
        const report = {
            timestamp: new Date(),
    ...
    async handleClearCaches(args, correlationId) {
    ...
    async handleGetSystemHealthResource() {
        const health = this.healthMonitor.getSystemHealth();
        return {
            contents: [
                {
    ...
    async handleGetSystemMetricsResource() {
        const metrics = this.performanceOptimizer.getMetrics();
        return {
            contents: [
                {
    ...
    async handleGetSystemLogsResource() {
    ...
    async handleGetSystemAlertsResource() {
    ...
    async handleGetIntegrationServersResource() {
    ...
    async handleGetCoordinationWorkflowsResource() {
    ...
    async run() {
        try {
            ...
            this.healthMonitor.log('error', 'Failed to start server', 'server', { error: error.message });
            throw error;
        }
    }
}
