...
export const GetPersonaRecommendationSchema = z.object({
    ...
    currentPersona: z.enum(PERSONA_NAMES).optional(),
    options: z.object({
        includeConfidenceBreakdown: z.boolean().optional(),
        maxRecommendations: z.number().optional(),
        excludePersonas: z.array(z.enum(PERSONA_NAMES)).optional()
    }).optional()
});
...
export const CoordinatePersonasSchema = z.object({
    personas: z.array(z.enum(PERSONA_NAMES)),
    operation: z.object({
        type: z.string(),
        description: z.string(),
        parameters: z.any(),
...
export const GetPersonaPrioritiesSchema = z.object({
    ...
    options: z.object({
        ...
        comparativeAnalysis: z.array(z.enum(PERSONA_NAMES)).optional()
    }).optional()
});
export const ShareExpertiseSchema = z.object({
    fromPersona: z.enum(PERSONA_NAMES),
    toPersona: z.enum(PERSONA_NAMES),
    expertise: z.object({
...
export const activatePersonaTool = {
...
export const getPersonaRecommendationTool = {
...
export const applyPersonaBehaviorTool = {
...
export const coordinatePersonasTool = {
...
export const getPersonaPrioritiesTool = {
...
export const shareExpertiseTool = {
